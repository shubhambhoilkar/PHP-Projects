...
<body>
    <div class="container">
        ...
        <div class="examples">
            <h3>Examples of Different Data Types:</h3>
            <p><strong>String:</strong> "Hello World", 'PHP'</p>
            <p><strong>Integer:</strong> 123, -100, 0</p>
            <p><strong>Float (Double):</strong> 3.14, -0.99, 0.0</p>
            <p><strong>Boolean:</strong> true, false</p>
            <p><strong>Array:</strong> [1, 2, 3], ["apple", "banana", "cherry"]</p>
            <p><strong>Object:</strong> new ClassName(), $obj = new stdClass()</p>
            <p><strong>NULL:</strong> NULL, unset($var)</p>
            <p><strong>Resource:</strong> file resource, database connection</p>
        </div>
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            // serialize() - Serialize the variable to a storable string
            echo "<p><strong>serialize:</strong> " . serialize($input_var) . "</p>";

            // settype() - Set the type of a variable
            settype($input_var, "string");
            echo "<p><strong>settype (converted to string):</strong> $input_var</p>";

            // strval() - Convert to string
            echo "<p><strong>strval:</strong> " . strval($input_var) . "</p>";

            // unserialize() - Unserialize a storable string back to a variable
            echo "<p><strong>unserialize:</strong> " . unserialize(serialize($input_var)) . "</p>";

            // unset() - Unset the variable (destroy it)
            unset($input_var);
            echo "<p><strong>unset:</strong> Variable has been unset.</p>";

            // var_dump() - Dump information about the variable
            echo "<p><strong>var_dump:</strong> ";
            var_dump($input_var);
            echo "</p>";

            // var_export() - Export the variable as a valid PHP code
